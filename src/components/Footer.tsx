      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-muted-foreground max-w-md">
              Open-source platform to visualize, build, and understand neural
              networks in 2D & 3D. Making AI education accessible to everyone.
            </p>
          </div>
        ...
        <div className="border-t border-border/50 mt-8 pt-8 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-muted-foreground text-sm">
            © 2025 OpenNetwork. Open source under Apache 2.0 License.
          </p>
