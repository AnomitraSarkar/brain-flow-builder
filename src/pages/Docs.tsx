      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <Button 
            ...
            onClick={() => window.open('https://github.com/AnomitraSarkar/brain-flow-builder', '_blank')}
          >
        ...
        <div className="neural-card mb-12">
          <h2 className="text-3xl font-bold mb-8 gradient-text">Complete Feature Guide</h2>
          
          {/* Layer System */}
          <div className="mb-12">
            <h3 className="text-2xl font-semibold mb-6 text-primary">🧠 Layer System</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="neural-card border border-primary/20">
                <h4 className="text-lg font-semibold mb-3 text-primary">Core Layers (Trainable)</h4>
              ...
              <div className="neural-card border border-secondary/20">
                <h4 className="text-lg font-semibold mb-3 text-secondary">Operators (Stateless)</h4>
                <ul className="text-sm text-muted-foreground space-y-1">
              ...
              <div className="neural-card border border-accent/20">
                <h4 className="text-lg font-semibold mb-3 text-accent">Activations</h4>
                <ul className="text-sm text-muted-foreground space-y-1">
          ...
          {/* Visualization Modes */}
          <div className="mb-12">
            <h3 className="text-2xl font-semibold mb-6 text-secondary">🎨 Visualization Modes</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="neural-card">
                <h4 className="text-lg font-semibold mb-3">3D Interactive View</h4>
                <ul className="text-sm text-muted-foreground space-y-2">
          ...
          {/* Analysis Tools */}
          <div className="mb-12">
            <h3 className="text-2xl font-semibold mb-6 text-accent">📊 Analysis Tools</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="neural-card">
                <h4 className="text-lg font-semibold mb-3">Training Simulation</h4>
                <ul className="text-sm text-muted-foreground space-y-1">
          ...
          {/* Import/Export */}
          <div className="mb-8">
            <h3 className="text-2xl font-semibold mb-6">💾 Import/Export System</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="neural-card">
                <h4 className="text-lg font-semibold mb-3">Network Configuration</h4>
                <ul className="text-sm text-muted-foreground space-y-2">
              ...
              <div className="neural-card">
                <h4 className="text-lg font-semibold mb-3">Integration Ready</h4>
                <ul className="text-sm text-muted-foreground space-y-2">
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="bg-muted/20 rounded-lg p-4">
                  ...
                  <p className="text-sm text-muted-foreground">Switch between 2D canvas and 3D visualization modes using the toolbar.</p>
                </div>
                <div className="bg-muted/20 rounded-lg p-4">
                  <h4 className="font-semibold mb-2">2. Add Layers</h4>
                  <p className="text-sm text-muted-foreground">Drag layers from the toolbox into your canvas. Choose from Core, Operators, Activations, and more.</p>
                </div>
                <div className="bg-muted/20 rounded-lg p-4">
                  <h4 className="font-semibold mb-2">3. Configure & Connect</h4>
                  <p className="text-sm text-muted-foreground">Click layers to edit parameters. Connect them by dragging from output to input nodes.</p>
                </div>
                <div className="bg-muted/20 rounded-lg p-4">
                  <h4 className="font-semibold mb-2">4. Analyze & Export</h4>
                  <p className="text-sm text-muted-foreground">Use the metrics panel to visualize weights and activations. Export your network when ready.</p>
                </div>
              </div>
            </div>
            
            <div>
              <h3 className="text-lg font-semibold mb-3 text-secondary">Pro Tips</h3>
              <div className="space-y-3">
                <div className="flex items-start space-x-3 p-3 rounded-lg bg-muted/10">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Use the tab system to quickly find the right layer type for your architecture.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3 p-3 rounded-lg bg-muted/10">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Use mouse controls to orbit, zoom, and explore your network in 3D space.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3 p-3 rounded-lg bg-muted/10">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Watch activation functions and weight distributions update as you modify layers.</p>
                  </div>
                </div>
              </div>
            </div>
